#!/usr/bin/env python3
"""
model_train_re-ranking.py
─────────────────────────
create_reranking_model_train_data.py 로 생성된 feature/label로
10-Fold OOF 이진 분류 MLP 모델을 학습합니다.

[입력]
  re-ranking_features.npz : shape (10000, 33)
...
# 🔹 Configuration
# =============================================================================
FEATURE_PATH = "/home/syback/vectorDB/on-device/data/model/re-ranking/re-ranking_features.npz"

MODEL_SAVE_DIR = "/home/syback/vectorDB/on-device/data/model/re-ranking"
