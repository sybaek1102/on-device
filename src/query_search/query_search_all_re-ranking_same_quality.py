#!/usr/bin/env python3
"""
query_search_all_re-ranking_same_quality.py
───────────────────────────────────────────────
PQ Index (M=32, same_quality)로 top-16 후보를 뽑은 뒤, 실제 L2 거리로 re-ranking해 top-1을 반환합니다.
...
NAME           = "all_same_quality"   # JSON 파일명 prefix
...
PQ_INDEX_PATH = os.path.join(INDEX_DIR, f"{CREATION_DATE}_same_quality_pq.index")
