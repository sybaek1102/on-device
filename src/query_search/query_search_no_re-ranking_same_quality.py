#!/usr/bin/env python3
"""
query_search_no_re-ranking_same_quality.py
───────────────────────────────────────────
Re-ranking 없이 PQ Index (M=32, same_quality) 검색 결과의 top-1을 바로 반환하고 성능을 평가합니다.
...
NAME          = "no_same_quality"   # JSON 파일명 prefix
