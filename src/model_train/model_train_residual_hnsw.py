#!/usr/bin/env python3
"""
model_train_residual_hnsw.py
─────────────────────────────
create_residual_model_train_data_hnsw.py 로 생성된 feature / label 로
10-Fold OOF MLP 모델을 학습합니다. (HNSW 버전)
...
# 🔹 Configuration
# =====================================================================
FEATURE_PATH = "/home/syback/vectorDB/on-device/data/model/residual_hnsw/residual_features_hnsw.npz"
LABEL_PATH   = "/home/syback/vectorDB/on-device/data/model/residual_hnsw/residual_label_hnsw.npz"

MODEL_SAVE_DIR = "/home/syback/vectorDB/on-device/data/model/residual_hnsw"
